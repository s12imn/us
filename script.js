...
console.log(currentText);
    switch (currentText) {
        ...
        case 'This distance relationship makes us value each other so much and makes us build a very strong trust more than we can ever imagine. Each time I leave you and i walk to the airport, I feel like the walk is so hard like there is a power pulling me back tying my legs and my arms not allowing me to walk forward the gate, a power stronger than gravity pulling me to your direction to your arms!!':
            greeting.textContent = 'I hope that with this relationship you will know how worthy you always were and are and will be, and I want to let you know that you were never asking for too much before and I hope that this love will make up for all the times you were asked to slaughter your instincts or you tried to break yourself down just to comfort or impress someone who was not meant to you.';
            break;
